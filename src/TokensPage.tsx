const colors = [
  ...
  { name: 'success',       hex: '#4CD137' },
  { name: 'success-shade', hex: '#44BD32' },
  { name: 'warning',       hex: '#E1B12C' },
  { name: 'warning-shade', hex: '#B98F1E' },
  { name: 'warning-light', hex: '#FBF6DC' },
  { name: 'ink',           hex: '#0A0F1E' },
  { name: 'black-grey',    hex: '#2F3640' },
  { name: 'steel-grey',    hex: '#718093' },
  { name: 'jeans-grey',    hex: '#7F8FA6' },
  { name: 'rain-grey',     hex: '#B1B8C2' },
  { name: 'moon-grey',     hex: '#BCC3CE' },
  { name: 'cloud-grey',    hex: '#C8D0DC' },
  { name: 'mist',          hex: '#F0F2F5' },
